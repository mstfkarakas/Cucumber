...
public class ReusableMethods {
    ...
    // when we sent a common locator of a lot of WebElements, method will return text values of these
...
//   waitFor(5);  => waits for 5 second
    ...
    public static void writeExcelFileSayfa1(int row, int column, String value){

        try {
            String filePath = "src/test/java/utilities/countries.xlsx";
            FileInputStream fis = new FileInputStream(filePath);
            Workbook workbook = WorkbookFactory.create(fis);
            workbook.getSheet("Sayfa1").getRow(row).getCell(column).setCellValue(value);
